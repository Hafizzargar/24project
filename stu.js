...
function search(){
    ...
    let emp={gender:undefined,class:undefined,marks:undefined,passing:undefined,email:undefined};    
    arr.map((e)=>{
        let fln = e.first_name.toLowerCase().concat(" " + e.last_name.toLowerCase());
        let input = inp1.value.toLowerCase(); 
        if (fln.includes(input)) {
